...
class Logger extends AbstractLogger
{
    ...
    {
        $this->logFilePath = $logDirectory . DIRECTORY_SEPARATOR;

        if ($this->options['filename']) {

            $this->logFilePath .= $this->options['filename'];

            if (strpos($this->options['filename'], '.log') === false && strpos($this->options['filename'], '.txt') === false) {

                $this->logFilePath .= '.' . $this->options['extension'];

            }

        } else {

            $this->logFilePath .= $this->options['prefix'] . date('Y-m-d') . '.' . $this->options['extension'];
